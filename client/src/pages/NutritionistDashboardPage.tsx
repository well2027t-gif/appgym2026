...
import { Apple, ArrowLeft, MessageCircle, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F8FBFF] pb-10">
      <div className="sticky top-0 z-20 bg-white border-b border-[#DBEAFE]">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-2">
          ...
          <div>
            ...
            <h1 className="text-[18px] font-black text-[#0F172A]">Nutricionista</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        <div className="grid grid-cols-3 gap-3">
          ...
          <Stat title="Planos" value="0" icon={<Apple size={16} />} />
            ...
            {clients.length === 0 ? (
              ...
              clients.map(item => (
                <div key={item.id} className="rounded-xl border border-[#DBEAFE] p-3 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => setLocation(`/painel/nutricionista/clientes/${item.userId}`)}
